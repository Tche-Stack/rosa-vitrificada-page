      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto animate-fade-in">
        <div className="glass-card p-8 md:p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              className="gradient-primary text-primary-foreground hover:opacity-90 animate-pulse-glow rounded-full px-8 py-6 text-lg font-semibold"
            >
              Agendar Consulta
            </Button>
            <Button 
              variant="outline" 
              size="lg"
              className="glass border-glass-border text-foreground hover:bg-glass rounded-full px-8 py-6 text-lg"
            >
              Conhecer Serviços
            </Button>
          </div>
